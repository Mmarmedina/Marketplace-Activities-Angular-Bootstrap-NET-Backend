...
namespace SPRENCIA.Infraestructure.Repositories
{
    public class ReviewRepository: IReviewRepository
    {
        ...
        // Sacar todas las opiniones juntas (tanto de Sprencia como de actividades), es decir, todos los registros de la tabla Reviews.
        ...
        // Método para sacar todas las opiniones sobre actividades. Son todas aquellas en las que el campo ActivityId en la tabla Reviews no es nulo (la opinión está asociada siempre a una actividad). 
        ...
        // Método para sacar solo las opiniones de Sprencia (son las que tienen el campo ActivityID = null). 
        ...
        // Método para recuperar todas las opiniones asociadas a una actividad
        ...
        // Método para recuperar una opinión por ID.
