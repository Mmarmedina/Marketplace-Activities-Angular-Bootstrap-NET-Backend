...
namespace SPRENCIA.Infraestructure.Mappers
{
    public class ScheduleMapper
    {
        ...
        public static List<ScheduleDto> MapToSchedulesDtoFromJoinActivitiesSchedulesActivities(ActivityDto activityDto, List<ActivitiesSchedulesSchedules> activitiesShedulesSchedules)
        {
            ...
            foreach (ActivitiesSchedulesSchedules activitiySheduleSchedule in activitiesShedulesSchedules)
            {
                foreach (ActivitiesSchedules activitySchedule in activitiySheduleSchedule.ActivitiesSchedules)
                {
          ...
          public static List<ScheduleDto> MapToSchedulesDtoFromJoinActivitiesSchedulesActivities(ActivityDto activityDto, List<ActivitiesSchedulesSchedules> activitiesShedulesSchedules)
        {
            ...
            // Se ha recibido por parémetro una lista que es la suma de ActivitiesSchedules + Schedules, almacenada en activitiesShedulesDto. 
            // Se usa un bucle anidado para iterar dentro de la tabla ActivitiesSchedules que está dentro de activitiesShedulesDto. 
            foreach (ActivitiesSchedulesSchedules activitySchedulesDtoItem in activitiesShedulesSchedules)
            {
