...
namespace SPRENCIA.Application.Mappers
{
    public class ScheduleMapper
    {
        ...
        public static List<ScheduleDto> MapToSchedulesDtoFromJoinActivitiesSchedulesSchedules(ActivityDto activityDto, List<ActivitiesSchedulesSchedules> activitiesShedulesDto)
        {
